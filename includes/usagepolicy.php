	...
	<body>
		...
		<div id="innertext">
			...
			<div style="margin:10px">
				...
				<div style="margin:10px;">
					<?php 
					echo $DEFAULT_TITLE.' Data Portal. '.date('Y').'. '; 
		    ...
		    <div>
				<ul>
					...
					<li>
						<?php echo $DEFAULT_TITLE; ?> expects that any use of data from this server will be accompanied with 
						the appropriate citations and acknowledgments. 
					</li>
			        <li>
			        	<?php echo $DEFAULT_TITLE; ?> encourages users to contact the original investigator responsible for 
					...
					<li>
						<?php echo $DEFAULT_TITLE; ?> asks that users not redistribute data obtained from this site. However, 
