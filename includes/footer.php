<footer>
	<div class="logo-gallery">
		...
		<a href="https://www.smnk.de/" target="_blank" aria-label="Naturkundemuseum Karlsruhe website">
			<img src="<?= $CLIENT_ROOT; ?>/images/layout/Karlsruhe.png"  alt="Naturkundemuseum Karlsruhe logo" />
		</a>
		<a href="https://www.ugent.be/" target="_blank" aria-label="Ghent University website">
			<img src="<?= $CLIENT_ROOT; ?>/images/layout/Gent.png"  alt="Ghent University logo" />
		</a>
	</div>
	<p>
