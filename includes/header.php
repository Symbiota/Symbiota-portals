		...
		<div class="top-wrapper">
			...
			<div class="top-brand">
				...
				<div class="brand-name">
					<h1>Intermountain Region Herbarium Network </h1>
					<h2></h2>
				</div>
			</div>
		</div>
		<div class="menu-wrapper">
			...
			<nav class="top-menu" aria-label="hamburger-nav">
				<ul class="menu">
					...
					<li>
						<a href="<?= $CLIENT_ROOT ?>/collections/specprocessor/crowdsource/index.php">
							Crowdsourcing
						</a>
					</li>
					<li>
						...
						<ul>
							<li>
								<a href="<?= $CLIENT_ROOT ?>/projects/index.php?proj=10">Regional Floras</a>
							</li>
							<li>
								<a href="<?= $CLIENT_ROOT ?>/projects/index.php?pid=77">Colorado Floras</a>
							</li>
							<li>
								<a href="<?= $CLIENT_ROOT ?>/projects/index.php?pid=78">Utah Floras</a>
							</li>
							<li>
