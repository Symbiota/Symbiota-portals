...
<table id="maintable" cellspacing="0">
	<tr>
		<td id="header" colspan="3">
			<div style="clear:both;height:100px;background-color:light-grey">
				<div style="margin:70px 0px 0px 30px;color:#57ad68;font:36px 'Ubuntu', sans-serif;font-weight:bold">
					TORCH
				</div>
				<div style="margin-left:30px;color:grey;font-size:130%;">
			...
			<div id="top_navbar">
				...
				<ul id="hor_dropdown">
					...
					<li>
						<a href="<?php echo $CLIENT_ROOT; ?>/projects/index.php" >Checklists &amp; Floras</a>
						<ul>
							<li>
								<a href="<?php echo $CLIENT_ROOT; ?>/projects/index.php?pid=112" >Oklahoma</a>
							</li>
							<li>
								<a href="<?php echo $CLIENT_ROOT; ?>/projects/index.php?pid=111" >Texas</a>
							</li>
						</ul>
					</li>
					<li>
