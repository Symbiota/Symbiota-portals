		...
		<div class="menu-wrapper">
			...
			<nav class="top-menu" aria-label="hamburger-nav">
				<ul class="menu">
					...
					<div id="custom-buttons" style="float: right">
						<?php
						if ($USER_DISPLAY_NAME) {
							?>
							<span id="profile">
								<form name="profileForm" method="post" action="<?= $CLIENT_ROOT . '/profile/viewprofile.php' ?>">
									<button class="button" name="profileButton" type="submit"><?= $LANG['H_MY_PROFILE'] ?></button>
								</form>
							</span>
							<span id="logout">
								<form name="logoutForm" method="post" action="<?= $CLIENT_ROOT ?>/profile/index.php?submit=logout">
									<button class="button" name="logoutButton" type="submit"><?= $LANG['H_LOGOUT'] ?></button>
								</form>
							</span>
							<?php
						} else {
							...
							<span id="login">
								<form name="loginForm" method="post" action="<?= $CLIENT_ROOT . "/profile/index.php" ?>">
									...
									<button class="button" name="loginButton" type="submit"><?= $LANG['H_LOGIN'] ?></button>
								</form>
							</span>
							<?php
						}
