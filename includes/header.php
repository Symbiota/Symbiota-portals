		...
		<div class="menu-wrapper">
			...
			<nav class="top-menu" aria-label="hamburger-nav">
				<ul class="menu">
					...
					<li>
						<a href="<?= $CLIENT_ROOT ?>/collections/exsiccati/index.php">
							Exsiccati
						</a>
					</li>
					<li>
					...
					<li>
						...
						<ul>
							<li>
								<a href="http://ngpherbaria.org/">Northern Great Plains</a>
							</li>
							<li>
								<a href="http://intermountainbiota.org/">Intermountain Herbaria</a>
							</li>
							<li>
								<a href="http://www.madrean.org/maba/symbflora/">MABA Flora</a>
							</li>
							<li>
								<a href="http://swbiodiversity.org/">SEINet</a>
							</li>
							<li>
								<a href="http://sernecportal.org/">SERNEC</a>
							</li>
						</ul>
					</li>
					<li>
