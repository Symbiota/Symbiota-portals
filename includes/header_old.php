...
<table id="maintable" cellspacing="0">
	<tr style="" >
		<td id="header" colspan="3">
			<div style="clear:both;width:100%;height:115px;border-bottom:1px solid #333333;background-color:#f8f7e3;">
				<div style="float:left;">
					<img style="" src="<?php echo $CLIENT_ROOT; ?>/images/layout/sernec.jpg" />
				</div>
			</div>
			<div id="top_navbar">
				...
				<ul id="hor_dropdown">
					...
					<li>
                                        ...
                                        <li>
                                                ...
                                                <ul>
                                                        <li>
                                                                <a href="<?php echo $CLIENT_ROOT; ?>/imagelib/index.php" >Image Library</a>
                                                        </li>
                                                        <li>
					...
					<li>
						...
						<ul>
							<li>
								<a href="<?php echo $CLIENT_ROOT; ?>/projects/index.php?proj=84" >State Floras</a>
							</li>
							<li>
								<a href="<?php echo $CLIENT_ROOT ?>/projects/index.php?proj=106">Kentucky Flora</a>
							</li>
						</ul>
					</li>
					<li>
