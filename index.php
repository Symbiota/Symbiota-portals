	...
	?> 
		...
		<div style="float:right;margin:10px;width:290px;text-align:center;">
			...
			<a href="<?php echo $CLIENT_ROOT; ?>/games/ootd/index.php?oodid=<?php echo $oodID.'&cl='.$ootdGameChecklist.'&title='.$ootdGameTitle.'&type='.$ootdGameType; ?>">
				<img src="<?php echo $gameInfo['images'][0].'?ver='.date('Ymd'); ?>" style="width:250px;border:0px;" />
			</a><br/>
		...
		*/
		...
		<div style="margin:20px;">
			...
			Por muchas razones, la investigación tropical está avanzando a un ritmo lento, especialmente considerando los niveles de amenaza crecientes que experimentan las ecozonas tropicales en los últimos tiempos.
                </div>
			...
			así como orientar a los jóvenes para que se conviertan en nuestros futuros científicos. Este sitio web se esfuerza por integrar el conocimiento y los datos de la comunidad biológica para sintetizar una red de bases de datos y herramientas que ayudarán a
